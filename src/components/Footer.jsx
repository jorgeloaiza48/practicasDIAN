...
import logopersonal from './logopersonal.ico'
      ...
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          <div className="text-teal-600">
            <img className="h-40 w-86 object-scale-down rounded-xl" src={logopersonal}/>
          </div>
        ...
        <p className="text-xs text-gray-500">&copy; 2025. Jorge Eliécer Loaiza Muñoz. All rights reserved.</p>
      </div>
    </footer>
